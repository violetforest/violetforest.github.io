...
var Application = function () {
  ...
  function Application() {
    ...
    this.loader = PIXI.loader.add('../divebar/textures/rain/alpha.png').add('../divebar/textures/rain/shine.png').add('../divebar/textures/rain/background.jpg').add('../divebar/textures/rain/foreground.jpg').load(function () {
...
var EffectCanvas = function () {
  ...
  function EffectCanvas(width, height, loader) {
    ...
    shaderData.uniforms.uTextureDropShine.value = loader.resources['../divebar/textures/rain/shine.png'].texture;
    shaderData.uniforms.uTextureBackground.value = loader.resources['../divebar/textures/rain/background.jpg'].texture;
    shaderData.uniforms.uTextureForeground.value = loader.resources['../divebar/textures/rain/foreground.jpg'].texture;
    shaderData.uniforms.vTextureSize.value = [loader.resources['../divebar/textures/rain/background.jpg'].texture.width, loader.resources['../divebar/textures/rain/background.jpg'].texture.height];
...
var DropletManager = function () {
  ...
  function DropletManager(stage, loader) {
    ...
    this.dropletSmallTexture = loader.resources['../divebar/textures/rain/alpha.png'].texture;
    this.dropletLargeTexture = loader.resources['../divebar/textures/rain/alpha.png'].texture;
